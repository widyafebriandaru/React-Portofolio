...
function PortfolioItem({
  ...
  //To make phone screen not show description preview
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="bg-white/10 fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-md p-2 shadow max-h-screen ">
            <Dialog.Close className="flex justify-end w-full pb-1">
              <Cross2Icon className="font-bold h-5 w-5 text-white " />
            </Dialog.Close>
            <img
              src={imgGif}
              alt="Preview"
            ...
            {desc && screenSize === "large" && (
              <p className="font-semibold text-stone-900 dark:text-stone-300 bg-neutral-300 dark:bg-stone-900 px-5 py-2 text-center">
                {desc}
              </p>
            )}
            ...
            <div className="mt-2 flex items-center">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-2 bg-orange-300 hover:bg-orange-400 rounded-md sm:text-sm mr-2 items-center text-xs"
              >
                Go to website
              </a>
              <a
              ...
              {github2 && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-stone-600 hover:bg-stone-800 p-2 ml-2 font-semibold text-white inline-flex items-center space-x-2 rounded-full"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    xmlnsXlink="http://www.w3.org/1999/xlink"
...
PortfolioItem.propTypes = {
  ...
  github2: PropTypes.string.isRequired,
  desc: PropTypes.string.isRequired,
  imgGif: PropTypes.string.isRequired,
};
